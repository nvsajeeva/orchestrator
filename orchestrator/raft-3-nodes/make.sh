...
for i in 1 2 3; do
  ...
  sed -i .bak "s/RAFT_NODES_ARRAY/${ORCHESTRATOR_NODES_ARRAY}/" cnf_files/orchestrator_$i.cnf
done

sed -i .bak "s/THIS_NODE_IP_ADDRESS/${ORCHESTRATOR_NODE_1}/" cnf_files/orchestrator_1.cnf
sed -i .bak "s/THIS_NODE_IP_ADDRESS/${ORCHESTRATOR_NODE_2}/" cnf_files/orchestrator_2.cnf
sed -i .bak "s/THIS_NODE_IP_ADDRESS/${ORCHESTRATOR_NODE_3}/" cnf_files/orchestrator_3.cnf
